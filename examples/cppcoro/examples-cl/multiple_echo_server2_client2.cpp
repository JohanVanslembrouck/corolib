...
async_task<void> echoClient(io_service& ioSvc, cppcoro::net::socket& listeningSocket)
{
...
async_task<void> manyEchoClients(io_service& ioSvc, cppcoro::net::socket& listeningSocket, cancellation_source& canceller, int count)
{
...
async_task<void> mainflow(io_service& ioSvc)
{
    ...
    async_task<void> tc = manyEchoClients(ioSvc, listeningSocket, canceller, count);
