...
* Variant of echo_server1_client1.cpp: lambdas have been replaced with normal functions.
* 
...
task<int> echoClient(io_service& ioSvc, socket& listeningSocket)
{
...
void mainflow()
{
    ...
    (void)sync_wait(when_all(
        [&]() -> task<int>
        {
            ...
            (void)co_await when_all(echoServer(ioSvc, listeningSocket),
                                    echoClient(ioSvc, listeningSocket));
            co_return 0;
        }(),
        [&]() -> task<int>
        {
