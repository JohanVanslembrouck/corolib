...
public:
    ...
    {
        print(PRI2, "async_generator_promise_base::request_cancellation()\n");
...
public:
    ...
    {
        print(PRI2, "async_generator_yield_operation::async_generator_yield_operation(async_generator_promise_base& promise, state initialState)\n");
    }
