 /**
  * @file multigreeter_coroutine_client3_lso.cc
  ...
  * 
  * multigreeter_coroutine_client3_lso.cc is a variant of multigreeter_coroutine_client2.cc.
  ...
  * 
  * In contrast to multigreeter_coroutine_client3.cc, this implementation uses a lso (lazy-start operation) and lazy-start coroutines.
  * 
