...
oneway_task mainflowOneClient(CommClient& c1, auto_reset_event& are, int counter)
{
	...
	// Connecting
	print(PRI1, "mainflowOneClient: async_operation sc1 = c1.start_connecting();\n");
	...
	str += " to echo\n";
	print(PRI1, "mainflowOneClient: async_operation sw1 = c1.start_writing(...);\n");
	async_operation sw1 = c1.start_writing(str.c_str(), str.length() + 1);
	print(PRI1, "mainflowOneClient: co_await sw1;\n");
	co_await sw1;

	// Reading
	print(PRI1, "mainflowOneClient: async_operation_t<std::string> sr1 = c1.start_reading();\n");
...
async_task<int> mainflow0(CommClient& c1, CommClient& c2, CommClient& c3)
{
	...
	for (int i = 0; i < 40; i++)
	{
		...
		async_operation sc1 = c1.start_connecting();
		print(PRI1, "mainflow0: async_operation sc2 = c2.start_connecting();\n");
		async_operation sc2 = c2.start_connecting();
		print(PRI1, "mainflow0: async_operation sc3 = c3.start_connecting();\n");
		...
		print(PRI1, "mainflow0: async_operation sw1 = c1.start_writing(...);\n");
		async_operation sw1 = c1.start_writing(str1.c_str(), str1.length() + 1);
		print(PRI1, "mainflow0: async_operation sw2 = c2.start_writing(...);\n");
		async_operation sw2 = c2.start_writing(str2.c_str(), str2.length() + 1);
		print(PRI1, "mainflow0: async_operation sw3 = c3.start_writing(...);\n");
...
#endif
		// Reading
		print(PRI1, "mainflow0: async_operation sr1 = c1.start_reading();\n");
		async_operation_t<std::string> sr1 = c1.start_reading('\n');
		print(PRI1, "mainflow0: async_operation sr2 = c2.start_reading();\n");
		async_operation_t<std::string> sr2 = c2.start_reading('\n');
		print(PRI1, "mainflow0: async_operation sr3 = c3.start_reading();\n");
