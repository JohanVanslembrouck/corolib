...
void completionflow(Class1460& obj)
{
    ...
    for (int i = 0; i < 12; i++)
    {
        print(PRI1, "completionflow(): before obj.m_object01.eventHandler[%d](10);\n", i);
        obj.m_object01.eventHandler[i](10);
        print(PRI1, "completionflow(): after obj.m_object01.eventHandler[%d](10);\n", i);

        print(PRI1, "completionflow(): before obj.m_object02.eventHandler[%d](10);\n", i);
        obj.m_object02.eventHandler[i](10);
        print(PRI1, "completionflow(): after obj.m_object02.eventHandler[%d](10);\n", i);
