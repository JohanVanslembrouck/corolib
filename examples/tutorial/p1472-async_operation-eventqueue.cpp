/**
 *  Filename: p1462-async_operation-eventqueue.cpp
 *  Description:
 *
...
async_task<int> coroutine4()
{
    ...
    print(PRI1, "coroutine4(): wait_all_awaitable<async_task<int>> wa({ &a, &b, &c });\n");
    wait_all_awaitable<async_task<int>> wa({ &a, &b, &c });
