...
int main()
{
    ...
    print(PRI1, "main: async_task<void> mf = mainflow();\n");
    async_task<void> mf = obj1920.mainflow();
    print(PRI1, "main: runEventQueue(eventQueue);\n");
    runEventQueue(eventQueue);
    print(PRI1, "main: mf.wait();\n");
	mf.wait();
