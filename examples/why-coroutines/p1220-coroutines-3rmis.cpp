...
void RemoteObject1Co::start_op2_impl(const int idx, int in11, int in12)
{
    ...
    m_remoteObject.sendc_op2(in11, in12, 
        [this, idx](int out21, int ret2)
        {
            ...
            if (om_async_operation_t)
            {
                print(PRI1, "%p: RemoteObject1Co::start_op2_impl(%d): om_async_operation_t->set_result()\n", this, idx);
            ...
            {
                // This can occur when the async_operation_base has gone out of scope.
                print(PRI1, "%p: RemoteObject1Co::start_op2_impl(%d): Warning: om_async_operation_t == nullptr\n", this, idx);
            }
        });
}
...
void RemoteObject1Co::start_op3_impl(const int idx, int in11)
{
    ...
    m_remoteObject.sendc_op3(in11, 
        [this, idx](int out31, int out32, int ret3)
        {
            ...
            if (om_async_operation_t)
            {
                print(PRI1, "%p: RemoteObject1Co::start_op3_impl(%d): om_async_operation_t->set_result()\n", this, idx);
            ...
            {
                // This can occur when the async_operation_base has gone out of scope.
                print(PRI1, "%p: RemoteObject1Co::start_op3_impl(%d): Warning: om_async_operation_t == nullptr\n", this, idx);
            }
        });
}
