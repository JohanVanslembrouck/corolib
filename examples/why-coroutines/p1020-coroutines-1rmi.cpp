...
public:
    async_task<void> coroutine1()
    {
        ...
        op1_ret_t ret = co_await remoteObj1.start_op1(in11, in12);
...
public:
    async_task<void> coroutine1()
    {
        ...
        printf("Class01::coroutine1(): out11 = %d, out12 = %d, ret1 = %d\n", out11, out12, ret1);
    ...
    async_task<void> coroutine1a()
    {
        ...
        ret1 = co_await op1;
        printf("Class01::coroutine1a(): out11 = %d, out12 = %d, ret1 = %d\n", out11, out12, ret1);
