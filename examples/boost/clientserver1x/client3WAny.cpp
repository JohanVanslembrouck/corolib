...
task<int> mainflowWA0(CommClient& c1, CommClient& c2, CommClient& c3)
{
    ...
    for (int i = 0; i < 60; i++)
    {
        ...
        // Connecting
        print(PRI1, "mainflowWA0: auto sc1 = c1.start_connecting(ep1);\n");
        auto sc1 = c1.start_connecting(ep1);
        print(PRI1, "mainflowWA0: auto sc2 = c2.start_connecting(ep1);\n");
        auto sc2 = c2.start_connecting(ep1);
        print(PRI1, "mainflowWA0: auto sc3 = c3.start_connecting(ep1);\n");
        auto sc3 = c3.start_connecting(ep1);
        ...
        print(PRI1, "mainflowWA0: auto sw1 = c1.start_writing(...);\n");
        auto sw1 = c1.start_writing(str1.c_str(), str1.length() + 1);
        print(PRI1, "mainflowWA0: auto sw2 = c2.start_writing(...);\n");
        auto sw2 = c2.start_writing(str2.c_str(), str2.length() + 1);
        print(PRI1, "mainflowWA0: auto sw3 = c3.start_writing(...);\n");
        auto sw3 = c3.start_writing(str3.c_str(), str3.length() + 1);
        ...
        // Reading
        print(PRI1, "mainflowWA0: auto sr1 = c1.start_reading();\n");
        auto sr1 = c1.start_reading();
        print(PRI1, "mainflowWA0: auto sr2 = c2.start_reading();\n");
        auto sr2 = c2.start_reading();
        print(PRI1, "mainflowWA0: auto sr3 = c3.start_reading();\n");
        auto sr3 = c3.start_reading();
...
task<int> mainflowOneClient(CommClient& c1, int instance, int counter)
{
    ...
    // Connecting
    print(PRI1, "mainflowOneClient: %d: auto sc1 = c1.start_connecting(ep1);\n", instance);
    auto sc1 = c1.start_connecting(ep1);
    ...
    str += " to echo\n";
    print(PRI1, "mainflowOneClient: %d: auto sw1 = c1.start_writing(...);\n", instance);
    auto sw1 = c1.start_writing(str.c_str(), str.length() + 1);
    print(PRI1, "mainflowOneClient: %d: co_await sw1;\n", instance);
    co_await sw1;

    // Reading
    print(PRI1, "mainflowOneClient: %d: auto sr1 = c1.start_reading();\n", instance);
    auto sr1 = c1.start_reading('\n');
