...
public:
        ...
        async_operation_base& cancelAction, async_operation_base& completeAction)
    {
        ...
        //print(PRI1, "one_client_write_reply: when_anyT<async_operation_base> war( { &st, &cancelAction } ) ;\n");
        //when_anyT<async_operation_base> war( { &st, &cancelAction} );
    ...
    oneway_task one_client(spCommCore commClient)
    {
        ...
        do
        {
            ...
            // whichever occurs first.
            //print(PRI1, "one_client: when_anyT<async_operation_base> war( { &completeAction, &sr2 } ) ;\n");
            //when_anyT<async_operation_base> war( { &completeAction, &sr2} );
