...
public:
    ...
    /**
     * @brief operation1 writes a request string onto the connection to the server and reads the response string.
    ...
    /**
     * @brief operation2 writes a request string onto the connection to the server and reads the response string.
    ...
    /**
     * @brief operation3 writes a request string onto the connection to the server and reads the response string.
    ...
    /**
     * @brief operation4 writes a request string onto the connection to the server and reads the response string.
    ...
    /**
     * @brief mainflow monitors the progress of mainflow(process_info_t);
     * mainflow first starts mainflow(process_info).
     * It then enters a loop where it prints the progress of mainflow(process_info_t) every 50 ms
     * using a timer.
     * @return async_task<void>
     */
