 ...
 * 
 * This application is based on server4.cpp.
 * A coroutine is passed as lambda (instead of a normal function in server4.cpp): 
 * it uses co_await and co_return in its implementation.
