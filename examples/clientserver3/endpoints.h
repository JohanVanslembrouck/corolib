 ...
 * @file endpoints.h
 * @brief
 * Defines the endpoints (IP address and port) used by the server application.
...
const boost::asio::ip::tcp::endpoint ep{ boost::asio::ip::make_address(ip_address_server), port_server };
