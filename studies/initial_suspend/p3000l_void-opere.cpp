 ...
 * @brief
 * Uses lazy start tasks and eager start operations.
 * 
...
task coroutine2()
{
    print(PRI1, "coroutine2(): async_oper<bool> op = start_create();\n");
    async_oper<bool> op1 = start_create();
    print(PRI1, "coroutine2(): bool res1 = co_await op1;\n");
    bool res1 = co_await op1;
    print(PRI1, "coroutine2(): res1 = %d\n", res1);

    print(PRI1, "coroutine2(): async_oper<int> op2 = start_open();\n");
    async_oper<int> op2 = start_open();
    ...
    char buffer[100];
    sprintf(buffer, "Input string\n");
    print(PRI1, "coroutine2(): async_oper<int> op3 = start_write(buffer);\n");
    async_oper<int> op3 = start_write(buffer);
    print(PRI1, "coroutine2(): int res3 = co_await op3;\n");
    int res3 = co_await op3;
    print(PRI1, "coroutine2(): res3 = %d\n", res3);

    print(PRI1, "coroutine2(): async_oper<std::string> op4 = start_read();\n");
    async_oper<std::string> op4 = start_read();
    print(PRI1, "coroutine2(): std::string res4 = co_await op4;\n");
    std::string res4 = co_await op4;
    print(PRI1, "coroutine2(): res4 = %s\n", res4.c_str());

    print(PRI1, "coroutine2(): async_oper<bool> op5 = start_close();\n");
    async_oper<bool> op5 = start_close();
    print(PRI1, "coroutine2(): bool res5 = co_await op5;\n");
    bool res5 = co_await op5;
    print(PRI1, "coroutine2(): res = %d\n", res5);

    print(PRI1, "coroutine2(): async_oper<bool> op6 = start_remove();\n");
    async_oper<bool> op6 = start_remove();
