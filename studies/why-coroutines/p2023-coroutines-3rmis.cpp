/**
 * @file p2023-coroutines-3rmis.cpp
 * @brief
 ...
 * This variant of p2022-coroutines-3rmis.cpp does not use reference (out) variables as coroutine parameters.
 * 
...
public:
    async_task<int> operationA(int in1, int& out1)
    {
        ...
        auto [inout31a, out31, ret3] = co_await operation3(in31, inout31);
        inout31 = inout31a;
    ...
    async_task<int3_t> operation3(int in31, int inout31)
    {
        ...
        int3_t res = co_await start_operation3(in31, inout31a);
        inout31a = res.el1;
        int out31 = res.el2;
        int ret = res.el3;
