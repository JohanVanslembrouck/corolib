...
public:
    ...
    {
        print(PRI1, "Class01a::coroutine1(in1 = %d, in2 = %d)\n", in1, in2);
        op1_ret_t ret = co_await remoteObj1co.start_op1(in1, in2);
        print(PRI1, "Class01a::coroutine1(): ret.out1 = %d, ret.out2 = %d, ret.ret = %d\n", ret.out1, ret.out2, ret.ret);
    ...
    async_task<int> coroutine1a(int in1, int in2)
    {
        ...
        print(PRI1, "Class01a::coroutine1a(): ret.out1 = %d, ret.out2 = %d, ret.ret = %d\n", ret.out1, ret.out2, ret.ret);
        co_return in1 + in2 + ret.out1 + ret.out2 + ret.ret;
    }
...
public:
    async_task<int> coroutine1(int in1, int in2)
    {
        print(PRI1, "Class01::coroutine1(in1 = %d, in2 = %d)\n", in1, in2);
        int out1 = -1, out2 = -1;
        int ret1 = co_await remoteObj1co.op1(in1, in2, out1, out2);
        print(PRI1, "Class01::coroutine1(): out1 = %d, out2 = %d, ret1 = %d\n", out1, out2, ret1);
    ...
    async_task<int> coroutine1a(int in1, int in2)
    {
        ...
        print(PRI1, "Class01::coroutine1a(): out1 = %d, out2 = %d\n", out1, out2);
        int ret1 = co_await op1;
        print(PRI1, "Class01::coroutine1a(): out1 = %d, out2 = %d, ret1 = %d\n", out1, out2, ret1);
        co_return in1 + in2 + out1 + out2 + ret1;
    }
...
public:
    ...
    {
        print(PRI1, "Class01b::coroutine1(in1 = %d, in2 = %d)\n", in1, in2);
        int ret1 = co_await remoteObj1co.op1(in1, in2, out1, out2);
        print(PRI1, "Class01b::coroutine1(): out1 = %d, out2 = %d, ret1 = %d\n", out1, out2, ret1);
        co_return in1 + in2 + out1 + out2 + ret1;
    }
    ...
    async_task<int> coroutine1a(int in1, int in2, int& out1, int& out2)
    {
        print(PRI1, "Class01b::coroutine1(in1 = %d, in2 = %d)\n", in1, in2);
        async_task<int> op1 = remoteObj1co.op1(in1, in2, out1, out2);
        print(PRI1, "Class01b::coroutine1a(): out1 = %d, out2 = %d\n", out1, out2);
        int ret1 = co_await op1;
        print(PRI1, "Class01b::coroutine1a(): out1 = %d, out2 = %d, ret1 = %d\n", out1, out2, ret1);
        co_return in1 + in2 + out1 + out2 + ret1;
    }
