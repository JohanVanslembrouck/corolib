/**
 * @file p1000cothreq.cpp
 * @brief This file contains the third of three implementations of the function start_op1_impl.
 * This implementation calls RemoteObject1::startthreq_op1.
 *
