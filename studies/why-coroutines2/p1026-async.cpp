                    ...
                    async_write(
                        [st, i = i + 1]() {
                            ...
                            async_read(
                                [st, i = i + 1]() {
                                    assert(i == st + 4);
                                    print(PRI1, "read complete: %d: write\n", i);
                                    async_write(
                                        [st, i = i + 1]() {
                                            assert(i == st + 5);
                                            print(PRI1, "write complete: %d: close\n", i);
                                            async_close(
                                                [st, i = i + 1]() {
                                                    assert(i == st + 6);
...
void start_create2(int st, int i);
void start_open2(int st, int i);
void start_write2(int st, int i);
void start_read2(int st, int i);
void start_write2a(int st, int i);
void start_close(int st, int i);
void start_remove(int st, int i);

void asynchronous_lambdas2(int st) {
    print(PRI1, "asynchronous_lambdas: begin\n");
    start_create2(st, st + 1);
    print(PRI1, "asynchronous_lambdas: end\n");
}
