...
struct tracker
{
    ...
    // initial_awaiter related
    int nr_initial_awaiters_constructed = 0;
    int nr_initial_awaiters_destructed = 0;
    int nr_currently_present_initial_awaiters = 0;
    int nr_max_simultaneously_present_initial_awaiters = 0;
    ...
    // awaiter related
    int nr_awaiters_constructed = 0;
    int nr_awaiters_destructed = 0;
    int nr_currently_present_awaiters = 0;
    int nr_max_simultaneously_present_awaiters = 0;
...
struct initial_awaiter_tracker
{
    initial_awaiter_tracker();
    ~initial_awaiter_tracker();
};
