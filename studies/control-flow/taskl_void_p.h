...
#ifndef _TASKL_VOID_P_H_
#define _TASKL_VOID_P_H_
...
public:
    ...
    public:
        ...
        initial_awaiter_lazy initial_suspend() noexcept {
            print(PRI3, "%p: promise_type::get_return_object() -> suspend_always_p\n", this);
            return {};
        }
    ...
    void start() {
        counter++;
        int counter1 = counter;
        print(PRI3, "%p: %d: task::start() -> void: enter\n", this, counter);
        if (coro_) {
            tracker_obj.nr_resumptions++;
            counter++;
            int counter2 = counter;
            print(PRI3, "%p: %d: task::start() -> void: before coro_.resume();\n", this, counter);
            coro_.resume();
            print(PRI3, "%p: %d: task::start() -> void: after coro_.resume();\n", this, counter2);
        }
        print(PRI3, "%p: %d: task::start() -> void: leave\n", this, counter1);
    }
    ...
    public:
        bool await_ready() noexcept {
            counter++;
            print(PRI3, "%p: %d: task::awaiter::await_ready() -> bool: return false\n", this, counter);
            return false;
        }
        ...
        void await_suspend(coroutine_handle<> continuation) noexcept {
            ...
            counter++;
            int counter2 = counter;
            print(PRI3, "%p: %d: task::awaiter::await_suspend() -> void: before coro_.resume();\n", this, counter);
            coro_.resume();
            print(PRI3, "%p: %d: task::awaiter::await_suspend() -> void: after  coro_.resume();\n", this, counter2);
