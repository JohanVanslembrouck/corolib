...
tracker::~tracker()
{
    ...
    print(PRI1, "ini\t%d\t%d\t%d\t%d\t%d\t%d\n",
        nr_initial_awaiters_constructed,
        nr_initial_awaiters_destructed,
        nr_initial_awaiters_constructed - nr_initial_awaiters_destructed,
        nr_max_simultaneously_present_initial_awaiters,
        nr_initial_awaiters_await_suspend_returning_true,
        nr_initial_awaiters_await_suspend_returning_false);
    print(PRI1, "awa\t%d\t%d\t%d\t%d\t%d\t%d\n",
        nr_awaiters_constructed,
        nr_awaiters_destructed,
        nr_awaiters_constructed - nr_awaiters_destructed,
        nr_max_simultaneously_present_awaiters,
        nr_awaiters_await_suspend_returning_true,
        nr_awaiters_await_suspend_returning_false);
    ...
    print(PRI1, "pro\t%d\t%d\t%d\t%d\n",
        ...
        nr_promise_types_constructed - nr_promise_types_destructed,
        nr_max_simultaneously_present_promise_types);
    print(PRI1, "ini\t%d\t%d\t%d\t%d\n",
        nr_initial_awaiters_constructed,
        nr_initial_awaiters_destructed,
        nr_initial_awaiters_constructed - nr_initial_awaiters_destructed,
        nr_max_simultaneously_present_initial_awaiters);
    print(PRI1, "awa\t%d\t%d\t%d\t%d\n",
        nr_awaiters_constructed,
        nr_awaiters_destructed,
        nr_awaiters_constructed - nr_awaiters_destructed,
        nr_max_simultaneously_present_awaiters);
...
initial_awaiter_tracker::initial_awaiter_tracker()
{
    ++tracker_obj.nr_initial_awaiters_constructed;
    ++tracker_obj.nr_currently_present_initial_awaiters;
    if (tracker_obj.nr_currently_present_initial_awaiters > tracker_obj.nr_max_simultaneously_present_initial_awaiters)
        tracker_obj.nr_max_simultaneously_present_initial_awaiters++;
}

initial_awaiter_tracker::~initial_awaiter_tracker()
{
    ++tracker_obj.nr_initial_awaiters_destructed;
    --tracker_obj.nr_currently_present_initial_awaiters;
}
...
awaiter_tracker::awaiter_tracker()
{
    ++tracker_obj.nr_awaiters_constructed;
    ++tracker_obj.nr_currently_present_awaiters;
    if (tracker_obj.nr_currently_present_awaiters > tracker_obj.nr_max_simultaneously_present_awaiters)
        tracker_obj.nr_max_simultaneously_present_awaiters++;
}

awaiter_tracker::~awaiter_tracker()
{
    ++tracker_obj.nr_awaiters_destructed;
    --tracker_obj.nr_currently_present_awaiters;
}
